...
namespace Gadgetron{
  ...
  template class hoLinearResampleOperator<float,1>;
  template class hoLinearResampleOperator<float,2>;
  template class hoLinearResampleOperator<float,3>;
  template class hoLinearResampleOperator<float,4>;

  template class hoLinearResampleOperator<double,1>;
  template class hoLinearResampleOperator<double,2>;
  template class hoLinearResampleOperator<double,3>;
  template class hoLinearResampleOperator<double,4>;
}
