...
#include "ABIBBSolver.h"
#include "hoNDArray_fileio.h"
#include <sstream>

namespace Gadgetron{

template<class ARRAY_TYPE> class hoABIBBSolver : public ABIBBSolver<ARRAY_TYPE>{

	typedef typename ARRAY_TYPE::element_type ELEMENT_TYPE;
	typedef typename realType<ELEMENT_TYPE>::Type REAL;
public:
	virtual ~hoABIBBSolver(){};
protected:
 ...
 */
template<class T> class hoABIBBSolver<cuNDArray<T> > {
	virtual void hoABIBBSolver_only_works_for_host_arrays() =0;
};
}
