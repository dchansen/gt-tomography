...
template<class T> class hoCuCgDescentSolver: public cgdescentSolver<hoCuNDArray<T> >{
	typedef typename realType<T>::Type REAL;
public:
	hoCuCgDescentSolver():cgdescentSolver<hoCuNDArray<T> >(){

	}

	virtual ~hoCuCgDescentSolver(){};
