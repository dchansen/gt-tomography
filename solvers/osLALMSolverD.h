...
namespace Gadgetron{
template <class ARRAY_TYPE> class osLALMSolverD : public solver< ARRAY_TYPE,ARRAY_TYPE> {
	typedef typename ARRAY_TYPE::element_type ELEMENT_TYPE;
	typedef typename realType<ELEMENT_TYPE>::Type REAL;
public:
	osLALMSolverD() :solver< ARRAY_TYPE,ARRAY_TYPE>() {
		_iterations=10;
